 ...
 */
class Zasedenost extends \Koledar\Entity\Zasedenost implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Koledar\\Entity\\Zasedenost' . "\0" . 'id', '' . "\0" . 'Koledar\\Entity\\Zasedenost' . "\0" . 'dogodek');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Zasedenost $proxy) {
