 ...
 */
class Vaja extends \Koledar\Entity\Vaja implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Koledar\\Entity\\Vaja' . "\0" . 'id', '' . "\0" . 'Koledar\\Entity\\Vaja' . "\0" . 'dogodek', '' . "\0" . 'Koledar\\Entity\\Vaja' . "\0" . 'uprizoritev');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Vaja $proxy) {
