 ...
 */
class Predstava extends \Koledar\Entity\Predstava implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Koledar\\Entity\\Predstava' . "\0" . 'id', '' . "\0" . 'Koledar\\Entity\\Predstava' . "\0" . 'dogodek', '' . "\0" . 'Koledar\\Entity\\Predstava' . "\0" . 'uprizoritev', '' . "\0" . 'Koledar\\Entity\\Predstava' . "\0" . 'gostovanje', '' . "\0" . 'Koledar\\Entity\\Predstava' . "\0" . 'gostujoca');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Predstava $proxy) {
