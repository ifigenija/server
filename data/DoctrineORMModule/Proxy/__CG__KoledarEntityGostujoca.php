 ...
 */
class Gostujoca extends \Koledar\Entity\Gostujoca implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Koledar\\Entity\\Gostujoca' . "\0" . 'id', '' . "\0" . 'Koledar\\Entity\\Gostujoca' . "\0" . 'predstave', '' . "\0" . 'Koledar\\Entity\\Gostujoca' . "\0" . 'uprizoritev');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Gostujoca $proxy) {
