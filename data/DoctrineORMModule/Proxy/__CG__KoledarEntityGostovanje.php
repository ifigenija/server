 ...
 */
class Gostovanje extends \Koledar\Entity\Gostovanje implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Koledar\\Entity\\Gostovanje' . "\0" . 'id', '' . "\0" . 'Koledar\\Entity\\Gostovanje' . "\0" . 'vrsta', '' . "\0" . 'Koledar\\Entity\\Gostovanje' . "\0" . 'dogodek', '' . "\0" . 'Koledar\\Entity\\Gostovanje' . "\0" . 'predstave', '' . "\0" . 'Koledar\\Entity\\Gostovanje' . "\0" . 'drzava');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Gostovanje $proxy) {
