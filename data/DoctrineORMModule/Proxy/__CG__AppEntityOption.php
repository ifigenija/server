...
class Option extends \App\Entity\Option implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'App\\Entity\\Option' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Option' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Option' . "\0" . 'type', '' . "\0" . 'App\\Entity\\Option' . "\0" . 'defaultValue', '' . "\0" . 'App\\Entity\\Option' . "\0" . 'value', '' . "\0" . 'App\\Entity\\Option' . "\0" . 'perUser');
        }
