 ...
 */
class OptionValue extends \App\Entity\OptionValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'App\\Entity\\OptionValue' . "\0" . 'id', '' . "\0" . 'App\\Entity\\OptionValue' . "\0" . 'value', '' . "\0" . 'App\\Entity\\OptionValue' . "\0" . 'global', '' . "\0" . 'App\\Entity\\OptionValue' . "\0" . 'option', '' . "\0" . 'App\\Entity\\OptionValue' . "\0" . 'user');
        }
