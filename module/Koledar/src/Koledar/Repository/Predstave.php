        ...
        extends AbstractMaxRepository
{
    ...
    private function preracunajZaporedne($object, $mode = 'update')
    {
         ...
         */
        $predstave = $this->findByUprizoritev($object->getUprizoritev());

        $predstave = $this->dodajOdstraniTrenutno($predstave, $object, $mode);
        ...
        /*
         * preštevilčenje predstav znotraj sezone
         */
